...
This Code of Conduct applies in all community spaces, including GitHub
issues and pull requests, Discord, and email. It also applies when someone
officially represents the community in public spaces.

## Enforcement

Report abusive, harassing or otherwise unacceptable behavior to the
maintainers at **[connect@yukthi.com](mailto:connect@yukthi.com)**. All
...
when deciding on consequences. These range from a private warning, through
a temporary ban, up to a permanent ban from the community.
